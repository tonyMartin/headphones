...
class WebInterface(object):
    ...
    def config(self):
        ...
        config = {
            ...
            "synology_host": headphones.CONFIG.SYNOLOGY_HOST,
            "synology_username": headphones.CONFIG.SYNOLOGY_USERNAME,
            "synology_password": headphones.CONFIG.SYNOLOGY_PASSWORD,
            ...
            "torrent_downloader_synology": radio(headphones.CONFIG.TORRENT_DOWNLOADER, 4),
